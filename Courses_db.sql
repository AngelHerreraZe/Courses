...
ALTER TABLE "courses" ADD FOREIGN KEY ("videos") REFERENCES "course_video" ("id");
...
INSERT INTO courses VALUES (1, 'Python de 0 a experto', 'Curso de python', 1, 1, 1), (2, 'PostgreSQL para principiantes', 'Curso de PostgreSQL', 1, 2, 2);
INSERT INTO users VALUES (1, 'Angel Herrera', 'password123', 27, 1, 1), (2, 'Ian Rosas', 'pass', 28, 2, 2);
INSERT INTO course_video VALUES (1, 'Introduccion e instalación de Pyton', 'https://www.youtube.com/watch?v=DAdRO6ByBoU'), (2, 'Introducción a postgreSQL', 'https://www.youtube.com/watch?v=_GKZu3DQAO0');